...
const RightSideBar = async () => {
  ...
  return (
    <section className="hidden lg:block  h-screen overflow-hidden overflow-y-scroll custom-scrollbar sticky right-0 top-0  pt-[7rem] pb-10 px-4 w-64 bg-white dark:bg-gray-900 ">
