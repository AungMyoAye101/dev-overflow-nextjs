...
const RightSideBar = async () => {
  ...
  return (
    <section className="bg_dark_white hidden lg:block  h-screen overflow-hidden overflow-y-scroll custom-scrollbar sticky right-0 top-0  pt-[7rem] pb-10 px-4 w-64 ">
